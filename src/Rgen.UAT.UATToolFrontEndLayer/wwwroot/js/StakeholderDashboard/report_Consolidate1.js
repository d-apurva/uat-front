...
var report2 = {
            ...
            case "Not Completed":
                {
                    ...
                    $("#tpFailCons").css("color", "white");
                    $("#tpExecCons").css("color", "white");
                    report2.currSelectedStatus = "Not Completed";
                    break;
                }
            case "Fail":
                {
                    ...
                    for (var mm = 0; mm < testCaseItems2.length; mm++) {
                        ...
                        if (status == "Executed" || report2.execMode == 1) {
                            if (status == "All")
                                ...
                                //var maxDate = new Date((report2.maxDate));
                                //var d = maxDate.getDate();
                                //var m = maxDate.getMonth() + 1;
                                //var y = maxDate.getFullYear();
                                //var max = y + "-" + report2.leadingZero(m) + "-" + report2.leadingZero(d);
                                //y = ""; m = ""; d = "";

                                //var minDate = new Date((report2.minDate))
                                //var d2 = minDate.getDate();
                                //var m2 = minDate.getMonth() + 1;
                                //var y2 = minDate.getFullYear();
                                //var min = y2 + "-" + report2.leadingZero(m2) + "-" + report2.leadingZero(d2);
                                //y2 = ""; m2 = ""; d2 = "";
                                ...
                                if ((testCaseItems2[mm]['status'] == "Not Completed" || testCaseItems2[mm]['status'] == "Pending" || testCaseItems2[mm]['status'] == undefined) && status == "Not Completed")
                                    showFlag = 1;
                        ...
                        if (showFlag == 1) {
                            ...
                            report2.allStatus.push(testCaseItems2[mm]['status']);
    ...
    showDataFromBuffer: function () {
        ...
        if (report2.currSelectedStatus == "Not Completed" && $.inArray("Not Completed", report2.allStatus) != -1 && $.inArray("Pending", report2.allStatus) != -1)
            report2.statusFilterFlagCons = 1;
