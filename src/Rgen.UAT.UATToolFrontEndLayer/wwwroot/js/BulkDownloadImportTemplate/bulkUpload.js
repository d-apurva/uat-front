        ...
        if (typeof (window.ActiveXObject) == undefined) {
            ...
            if ($.inArray(ext, ['xlsx', 'xls']) == -1) {
                ...
                if (ProjectID == show.projectId) {
                    ...
                    //var chk = excel_sheet.Cells(i, 7).Value
                    //if (excel_sheet.Cells(i, 7).Value.indexOf('!@#$%^&*()+=[];/{}|:<>?\"') > -1)
                    //{
                    //    Error_Listobj.push({
                    //        row: i,
                    //        sheetName: 'Test Pass',
                    ...
                    if (Error_Listobj.length == 0) {
                        ...
                        for (var i = startIndex; i <= endIndex; i++) {
                            if (excel_sheet.Cells(i, 5).Value != undefined) {
                                ...
                                var strin = excel_sheet.Cells(i, 7).Value;
                                
                                
                                ///if (strin.indexOf('!@#$%^&*()+=[];/{}|:<>?\"') !== -1)
                                //if (/^[a-zA-Z0-9- ]*$/.test(strin) == false)
                                // ^([a-zA-Z0-9 ]+)$
                                //to check role for special symbol
                                if (/^[a-zA-Z0-9, ]+$/.test(strin) == false)
                                {
                                    ...
                                    Error_Listobj.push({
                                        row: i,
                                        sheetName: 'Tester',
                                        Error: 'Role Name contains special characters. These are not allowed. Please remove them and try again!'
                                    });
                                    break;
                                }
                        ...
                        for (var i = startIndex; i <= endIndex; i++) {
                            if (excel_sheet.Cells(i, 4).Value != undefined) {
                                ...
                                if (excel_sheet.Cells(i, 10).Value != undefined) {
                                    ...
                                    var strin = excel_sheet.Cells(i, 10).Value;
        ...
        {
            {
                ...
                $.each(resArr, function (ind, itm) {
                    ...
                    if (itm.sheetName == "Tester") {
                        error = itm.Error.charAt(0) == "," ? itm.Error.replace(",", "") : itm.Error;

                        testerErr += "<span ><span style='color:brown;'>Row " + (parseInt(itm.row)) + "</span>: " + error + "</span><br />";
                    }
                    if (itm.sheetName == "Test Step") {
                        error = itm.Error.charAt(0) == "," ? itm.Error.replace(",", "") : itm.Error;

                        testStepErr += "<span ><span style='color:brown;'>Row " + (parseInt(itm.row)) + "</span>: " + error + "</span><br />";
                    }
