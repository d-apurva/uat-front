            ...
            $('#barChart img').mousemove(function (mEvent) {
                ...
                if (mEvent.offsetY >= 280 && mEvent.offsetY <= 295) {
                    $.each(Analysis.gTesterArr, function (ind, itm) {
                        if ($('.pagination').find('.current').not('.next').not('.prev').html() == 1) {
                            if (itm["PageNo"] == 1 && ind < 15) {
                                if ($("#testerDD option:selected").text() == 'All Testers') {
                                    if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                        $('#barChart img').attr("title", itm["Tester"]);
                                    }
                                }
                                else {
                                    var titleNew = $("#testerDD option:selected").text();
                                    $('#barChart img').attr("title", titleNew);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 2) {

                            if (itm["PageNo"] == 2 && ind > 14 && ind < 30) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 3) {

                            if (itm["PageNo"] == 3 && ind > 29 && ind < 45) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 4) {

                            if (itm["PageNo"] == 4 && ind > 44 && ind < 60) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 5) {

                            if (itm["PageNo"] == 5 && ind > 59 && ind < 75) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 6) {

                            if (itm["PageNo"] == 6 && ind > 74 && ind < 90) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 7) {

                            if (itm["PageNo"] == 7 && ind > 89 && ind < 105) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 8) {

                            if (itm["PageNo"] == 8 && ind > 104 && ind < 120) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 9) {

                            if (itm["PageNo"] == 9 && ind > 119 && ind < 135) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 10) {

                            if (itm["PageNo"] == 10 && ind > 134 && ind < 150) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 11) {

                            if (itm["PageNo"] == 11 && ind > 149 && ind < 165) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 12) {

                            if (itm["PageNo"] == 12 && ind > 164 && ind < 180) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 13) {

                            if (itm["PageNo"] == 13 && ind > 179 && ind < 195) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 14) {

                            if (itm["PageNo"] == 14 && ind > 194 && ind < 210) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
                        }
                        else if ($('.pagination').find('.current').not('.next').not('.prev').html() == 15) {

                            if (itm["PageNo"] == 15 && ind > 209 && ind < 225) {
                                if (mEvent.offsetX >= parseInt(itm["Range"]) && mEvent.offsetX <= parseInt(itm["Range"]) + 30) {
                                    $('#barChart img').attr("title", itm["Tester"]);
                                }
                            }
